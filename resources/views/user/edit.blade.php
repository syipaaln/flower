        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="NamaLengkap" class="form-control" placeholder="Nama Lengkap" value="{{ $user->NamaLengkap }}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Alamat:</strong>
                    <textarea class="form-control" style="height:150px" name="Alamat" placeholder="Content">{{ $user->Alamat }}</textarea>
                </div>
            </div>
